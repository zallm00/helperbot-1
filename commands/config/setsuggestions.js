...
const Conf = require("../../models/setsuggestions.js");

module.exports = {
    name: "setsuggestions",
    aliases: [],
    description: "Establish a suggestions channel on the server",
    category: "Config",
    usage: "setsuggestions <MENTION-CHANNEL>",
    ...
    run: async (client, message, args) => {
      ...
      .setDescription("Congratulations, the new suggestions channel is <#"+message.mentions.channels.first()+">\n\n*You can change it whenever you want*")
      .setColor('#00FC2A')
